...
const DifferentialPrivacyVisualizer = () => {
 ...
 const generateOrigins = (OD, celdas, lat_min, lon_min, paso_m) => {
    ...
    celdasArray.forEach(({ i, j, idx }) => {
      ...
      const paso  // Función auxiliar para colormap plasma (igual que matplotlib.pyplot.cm.plasma)
  const getPlasmaColor = (normalizado) => {
    // Interpolación de la paleta plasma de matplotlib
    const plasma = [
      ...
      [0.991206, 0.790537, 0.149377],
      [0.990434, 0.796859, 0.147870],
      [0.989580, 0.803205, 0.146529],
      [0.988648, 0.809579, 0.145357],
      [0.987621, 0.815975, 0.144363],
      [0.986509, 0.822396, 0.143557],
      [0.985314, 0.828840, 0.142945],
      [0.984031, 0.835308, 0.142528],
      [0.982653, 0.841797, 0.142303],
      [0.981190, 0.848308, 0.142279],
      [0.979644, 0.854842, 0.142453],
      [0.977995, 0.861396, 0.142808],
      [0.976265, 0.867971, 0.143351],
      [0.974443, 0.874565, 0.144061],
      [0.972530, 0.881180, 0.144923],
      [0.970533, 0.887814, 0.145919],
      [0.968443, 0.894467, 0.147014],
      [0.966271, 0.901138, 0.148180],
      [0.964021, 0.907828, 0.149370],
      [0.961681, 0.914536, 0.150520],
      [0.959276, 0.921262, 0.151566],
      [0.956808, 0.928005, 0.152409],
      [0.954287, 0.934766, 0.152921],
      [0.951726, 0.941544, 0.152925],
      [0.949151, 0.948340, 0.152178],
      [0.946602, 0.955153, 0.150328],
      [0.944152, 0.961982, 0.146861],
      [0.943257, 0.968659, 0.140956],
...
const generateDestinations = (OD, celdas, lat_min, lon_min, paso_m) => {
    ...
    celdasArray.forEach(({ i, j, idx }) => {
      ...
      // Plasma colormap (igual al código Python)
      ...
      const html = `
        ...
        <body>
          ...
          <div class="legend">
            ...
            <div style="width: 150px; height: 15px; background: linear-gradient(to right, rgb(68,1,84), rgb(59,82,139), rgb(33,145,140), rgb(253,231,37)); border: 1px solid #ccc; border-radius: 3px;"></div>
