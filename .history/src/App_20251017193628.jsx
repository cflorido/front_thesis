...
`;
  ...
  const loadCSVData = async (folder, paramStr, odType) => {
    try {
      const baseURL = 'https://cflorido.github.io/front_thesis';
      const odFile = `${baseURL}/${folder}/OD_${odType}_${paramStr}.csv`;
      const celdasFile = `${baseURL}/${folder}/celdas_${paramStr}.csv`;
      const minimosFile = `${baseURL}/${folder}/minimos_${paramStr}.csv`;
